...
{
    public static class TidefinVisualBuilder
    {
        private const string BuildMenuPath = "Fight/Stage 01/Build Tidefin Visual";
        private const string SourceSheetPath = "Assets/Art/Heroes/assassin_002_tidefin/tidefin_source_sheet.png";
        private const string ResourcesRoot = "Assets/Resources/HeroPreview/assassin_002_tidefin";
        private const string ResourcesPrefix = "HeroPreview/assassin_002_tidefin";
        private const string TidefinPrefabPath = "Assets/Prefabs/Heroes/assassin_002_tidefin/Tidefin.prefab";
        private const string TidefinPortraitPath = "Assets/Prefabs/Heroes/assassin_002_tidefin/Tidefin_idle_front.png";
        private const string TidefinHeroAssetPath = "Assets/Data/Stage01Demo/Heroes/assassin_002_tidefin/Tidefin.asset";
        private const string BuilderScriptAssetPath = "Assets/Scripts/Editor/TidefinVisualBuilder.cs";
        ...
        private static readonly ClipBuildSpec[] ClipBuildSpecs =
        {
            ...
            new ClipBuildSpec("Skill", 3, "tidal_pounce", 12f, false),
            new ClipBuildSpec("Ult", 4, "ruin_tide", 10f, false),
        ...
        public static void BuildTidefinVisual()
        {
            BuildAll();
            Debug.Log("Tidefin sprite-sheet visual prefab rebuilt.");
        }

        public static void BuildTidefinVisualBatch()
        {
            try
            {
                BuildAll();
        ...
        private static void TryAutoBuildIfNeeded()
        {
            ...
            SyncTidefinHeroAsset();
            AssetDatabase.SaveAssets();
        }

        private static bool NeedsRebuild()
        {
            if (AssetDatabase.LoadAssetAtPath<GameObject>(TidefinPrefabPath) == null)
            {
                return true;
            }
            ...
            return GetLatestTimestampUtc(BuilderScriptAssetPath, SourceSheetPath)
                > GetLatestTimestampUtc(TidefinPrefabPath, ResourcesRoot, TidefinPortraitPath);
        }
        ...
        private static void GenerateFrameFolders()
        {
            ...
            {
                throw new FileNotFoundException($"Missing Tidefin source sheet: {SourceSheetPath}");
            }
        ...
        private static void CreateTidefinPortrait()
        {
            EnsureFolder("Assets/Prefabs/Heroes/assassin_002_tidefin");
            ...
            File.Copy(absoluteSourcePath, ToAbsolutePath(TidefinPortraitPath), true);
            ApplyFrameTextureImporter(TidefinPortraitPath);
        }

        private static void CreateTidefinPrefab()
        {
            EnsureFolder("Assets/Prefabs/Heroes/assassin_002_tidefin");

            var root = new GameObject("Tidefin");
            ...
            PrefabUtility.SaveAsPrefabAsset(root, TidefinPrefabPath);
        ...
        private static void SyncTidefinHeroAsset()
        {
            var hero = AssetDatabase.LoadAssetAtPath<HeroDefinition>(TidefinHeroAssetPath);
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>(TidefinPrefabPath);
            ...
            var portrait = AssetDatabase.LoadAssetAtPath<Sprite>(TidefinPortraitPath);
            if (portrait != null)
            {
        ...
        private static RectInt[] BuildFrameRects(GridSpec grid, int sourceRow)
        {
            ...
            {
                throw new InvalidOperationException($"Tidefin source row {sourceRow} is outside the detected grid.");
            }
            ...
            int threshold)
        {
            ...
            if (groups.Count != expectedCount)
            {
                throw new InvalidOperationException(
                    $"Tidefin source grid detection expected {expectedCount} {(scanColumns ? "vertical" : "horizontal")} lines, found {groups.Count}.");
            }
