...
{
    public static class ButcherVisualBuilder
    {
        private const string BuildMenuPath = "Fight/Stage 01/Build Butcher Visual";
        private const string SourceSheetPath = "Assets/Art/Heroes/assassin_003_butcher/butcher_source_sheet.png";
        private const string ResourcesRoot = "Assets/Resources/HeroPreview/assassin_003_butcher";
        private const string ResourcesPrefix = "HeroPreview/assassin_003_butcher";
        private const string ButcherPrefabPath = "Assets/Prefabs/Heroes/assassin_003_butcher/Butcher.prefab";
        private const string ButcherPortraitPath = "Assets/Prefabs/Heroes/assassin_003_butcher/Butcher_idle_front.png";
        private const string ButcherHeroAssetPath = "Assets/Data/Stage01Demo/Heroes/assassin_003_butcher/Butcher.asset";
        private const string BuilderScriptAssetPath = "Assets/Scripts/Editor/ButcherVisualBuilder.cs";
        ...
        private static readonly ClipBuildSpec[] ClipBuildSpecs =
        {
            ...
            new ClipBuildSpec("Skill", 3, "gore_hook", 12f, false),
            new ClipBuildSpec("Ult", 4, "carnage_reel", 10f, false),
        ...
        public static void BuildButcherVisual()
        {
            BuildAll();
            Debug.Log("Butcher sprite-sheet visual prefab rebuilt.");
        }

        public static void BuildButcherVisualBatch()
        {
            try
            {
                BuildAll();
        ...
        private static void TryAutoBuildIfNeeded()
        {
            ...
            SyncButcherHeroAsset();
            AssetDatabase.SaveAssets();
        }

        private static bool NeedsRebuild()
        {
            if (AssetDatabase.LoadAssetAtPath<GameObject>(ButcherPrefabPath) == null)
            {
                return true;
            }
            ...
            return GetLatestTimestampUtc(BuilderScriptAssetPath, SourceSheetPath)
                > GetLatestTimestampUtc(ButcherPrefabPath, ResourcesRoot, ButcherPortraitPath);
        }
        ...
        private static void GenerateFrameFolders()
        {
            ...
            {
                throw new FileNotFoundException($"Missing Butcher source sheet: {SourceSheetPath}");
            }
        ...
        private static void CreateButcherPortrait()
        {
            EnsureFolder("Assets/Prefabs/Heroes/assassin_003_butcher");
            ...
            File.Copy(absoluteSourcePath, ToAbsolutePath(ButcherPortraitPath), true);
            ApplyFrameTextureImporter(ButcherPortraitPath);
        }

        private static void CreateButcherPrefab()
        {
            EnsureFolder("Assets/Prefabs/Heroes/assassin_003_butcher");

            var root = new GameObject("Butcher");
            ...
            PrefabUtility.SaveAsPrefabAsset(root, ButcherPrefabPath);
        ...
        private static void SyncButcherHeroAsset()
        {
            var hero = AssetDatabase.LoadAssetAtPath<HeroDefinition>(ButcherHeroAssetPath);
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>(ButcherPrefabPath);
            ...
            var portrait = AssetDatabase.LoadAssetAtPath<Sprite>(ButcherPortraitPath);
            if (portrait != null)
            {
        ...
        private static RectInt[] BuildFrameRects(GridSpec grid, int sourceRow)
        {
            ...
            {
                throw new InvalidOperationException($"Butcher source row {sourceRow} is outside the detected grid.");
            }
            ...
            int threshold)
        {
            ...
            if (groups.Count != expectedCount)
            {
                throw new InvalidOperationException(
                    $"Butcher source grid detection expected {expectedCount} {(scanColumns ? "vertical" : "horizontal")} lines, found {groups.Count}.");
            }
