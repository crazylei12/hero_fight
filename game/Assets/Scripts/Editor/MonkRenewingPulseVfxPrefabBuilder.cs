...
{
    public static class MonkRenewingPulseVfxPrefabBuilder
    {
        ...
        private const string MonkActiveSkillAssetPath = "Assets/Data/Stage01Demo/Skills/support_003_monk/Renewing Pulse.asset";
        ...
        public static void BuildMonkRenewingPulseVfxBatch()
        {
        ...
        private static void BuildRenewingPulseBurstPrefab(Sprite softCircleSprite)
        {
            ...
            ConfigureParticleSystems(areaLoop, durationCap: 0.95f, simulationSpeedFloor: 1.08f);
            ...
            ConfigureParticleSystems(areaPulse, durationCap: 0.85f, simulationSpeedFloor: 1.12f);
            ...
            ConfigureParticleSystems(flash, durationCap: 0.48f, simulationSpeedFloor: 1.25f);
            ...
            ConfigureParticleSystems(rings, durationCap: 0.72f, simulationSpeedFloor: 1.18f);
        ...
        {
            var pulsePrefab = AssetDatabase.LoadAssetAtPath<GameObject>(RenewingPulseBurstPrefabPath);
            var activeSkill = AssetDatabase.LoadAssetAtPath<SkillData>(MonkActiveSkillAssetPath);
            if (pulsePrefab == null || activeSkill == null)
            {
                return;
            }

            if (activeSkill.castImpactVfxPrefab == pulsePrefab
                ...
                && !activeSkill.castImpactVfxAlignToTargetDirection
                && activeSkill.castImpactVfxScaleWithSkillArea
                && Mathf.Approximately(activeSkill.castImpactVfxAreaDiameterScaleMultiplier, 1f))
            {
                return;
            }

            activeSkill.castImpactVfxPrefab = pulsePrefab;
            activeSkill.castImpactVfxLocalOffset = Vector3.zero;
            activeSkill.castImpactVfxEulerAngles = Vector3.zero;
            activeSkill.castImpactVfxScaleMultiplier = Vector3.one;
        ...
        private static void ConfigureParticleSystems(GameObject root, float durationCap, float simulationSpeedFloor)
        {
            if (root == null)
            {
                return;
            ...
            for (var i = 0; i < particleSystems.Length; i++)
            {
                ...
                main.duration = Mathf.Max(0.3f, Mathf.Min(main.duration, durationCap));
